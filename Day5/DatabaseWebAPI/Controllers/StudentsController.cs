    ...
    public class StudentsController : ApiController
    {
        ...
        public async Task<HttpResponseMessage> Get()
        {
            try
            {
                ...
                List<IStudent> studentsList = await Student.Get();
        ...
        public async Task<HttpResponseMessage> GetStudentCourses(int id)
        {
            try
            {
                return Request.CreateResponse(HttpStatusCode.OK, await Student.GetById(id));
            }
            catch
            {
                return Request.CreateResponse(HttpStatusCode.NotFound);
